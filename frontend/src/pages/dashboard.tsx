  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900">
        <div data-testid="loading-spinner" className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-primary-600"></div>
      </div>
    );
  }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div data-testid="profile-section" className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <div data-testid="stats-section" className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          ...
          <div data-testid="actions-section" className="mt-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Available Actions</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <button data-testid="find-game-btn" className="btn-primary p-4 flex flex-col items-center justify-center">
              ...
              <button data-testid="edit-profile-btn" className="btn-outline p-4 flex flex-col items-center justify-center">
