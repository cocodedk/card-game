...
class CreateIdiotRuleSetTests(MockNeo4jTestCase):
    """Tests for the create_idiot_rule_set function"""

    @patch('backend.game.models.GameRuleSet.create_idiot_card_game')
    def test_create_idiot_rule_set_default_parameters(self, mock_create_idiot_card_game):
        ...
        mock_create_idiot_card_game.assert_called_once()
    ...
    @patch('backend.game.models.GameRuleSet.create_idiot_card_game')
    def test_create_idiot_rule_set_custom_parameters(self, mock_create_idiot_card_game):
    ...
    @patch('backend.game.models.GameRuleSet.create_idiot_card_game')
    def test_card_actions_configuration(self, mock_create_idiot_card_game):
    ...
    @patch('backend.game.models.GameRuleSet.create_idiot_card_game')
    def test_targeting_rules_configuration(self, mock_create_idiot_card_game):
    ...
    @patch('backend.game.models.GameRuleSet.create_idiot_card_game')
    def test_win_conditions_configuration(self, mock_create_idiot_card_game):
    ...
    @patch('backend.game.models.GameRuleSet.create_idiot_card_game')
    def test_play_rules_configuration(self, mock_create_idiot_card_game):
