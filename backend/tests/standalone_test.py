...
# Create mock modules
mock_modules = [
    'backend.game.models.game_card',
    'backend.game.models.game_rule_set',
    'backend.game.models.card',
    'backend.game.models.deck',
    'backend.game.models.game',
    'backend.game.models.game_action',
    'backend.game.models.game_player',
    'backend.game.models.player',
    'backend.game.models.player_group',
    'backend.game.models.player_group_invitation',
    'backend.game.models.game_state',
    'backend.game.models.base',
    'backend.game.models'
]
...
sys.modules['backend.game.models.game_rule_set'].GameRuleSet = MockGameRuleSet
