#!/usr/bin/env python
"""
Test for create_idiot_rule_set
"""
import unittest
...
# Import and patch the function to test
import sys
import create_idiot_rule_set as module

# Save the original GameRuleSet
original_game_rule_set = module.GameRuleSet

# Replace with mock
module.GameRuleSet = MockGameRuleSet

# Get the function
create_idiot_rule_set = module.create_idiot_rule_set
...
if __name__ == "__main__":
    try:
        ...
        # Restore original GameRuleSet
        module.GameRuleSet = original_game_rule_set
